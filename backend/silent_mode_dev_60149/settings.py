"""
Django settings for silent_mode_dev_60149 project.
...
ROOT_URLCONF = 'silent_mode_dev_60149.urls'
...
WSGI_APPLICATION = 'silent_mode_dev_60149.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_mode_dev_60149 API",
    "DESCRIPTION": "API documentation for silent_mode_dev_60149 App",
    "VERSION": "v1",
}
